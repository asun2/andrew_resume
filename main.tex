...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
        {\textbf{aimbot} $|$ \emph{Python, OpenCV}}{August 2020 -}
            \resumeItemListStart
                \resumeItem{Designed and engineered a camera rig that is capable of free look, utilizing 2 servos and a camera.}
                \resumeItem{Added the ability to keep a moving object within frame, using OpenCV's built in object tracking, and comparing frames.}
        \resumeItemListEnd
        \resumeProjectHeading
        {\textbf{botcopium} $|$ \emph{Node.js, Discord.js}}{May 2021 -}
            \resumeItemListStart
                \resumeItem{Created a bot that responds to user requests.}
                \resumeItem{}
    \resumeSubHeadingListEnd
...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Administrative/IT}{May 2019 -- Present}
